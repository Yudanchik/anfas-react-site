      ...
      <PageWrapper>
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.heroAside}>
              <div className={styles.heroCard}>
                ...
                <p>
                  Для тех, кому нужен проект под себя, продуманная планировка и точная работа с
                  деталями.
                </p>
              </div>
              <div className={styles.heroCard}>
                <span>Пакетный формат</span>
                <p>
                  Для тех, кто хочет быстрее стартовать и сразу понимать бюджет, сроки и состав
                  решений.
                </p>
              </div>
            </div>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.compare}>
            <article className={styles.compareCard} data-reveal>
              ...
              <h3>Когда важна уникальность и гибкость</h3>
              <p>
            ...
            <article className={styles.compareCard} data-reveal>
              ...
              <p>
                Подходит, если вы хотите быстрее перейти к результату, заранее понимать бюджет и не
                тратить недели на сравнение каждого материала, света и позиции вручную.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className={styles.formSection} data-reveal>
          <div className={styles.formHeader}>
            ...
            <p>
              Если пока неясно, что лучше для вашей квартиры, оставьте имя и телефон. Мы свяжемся,
              уточним задачу и подскажем, с чего лучше начать: с индивидуального проекта или с
              пакетного ремонта.
            </p>
          </div>
