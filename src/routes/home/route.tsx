    ...
    <main>
      <section id="top" className="hero" ref={heroRef} onMouseMove={handleHeroMove}>
        ...
        <div className="hero-grid">
          <div className="hero-copy">
            ...
            <button className="primary-button" type="button" onClick={openBrief}>
      ...
      <section id="process" className="process section-pad">
        <div className="process-intro">
          ...
          <button className="outline-button" type="button" onClick={openBrief} data-reveal>
      ...
      <section id="contacts" className="contact">
        ...
        <button className="contact-button" type="button" onClick={openBrief} data-reveal>
