...
const privacySections = [
  {
    ...
    text: [
      `Настоящая политика объясняет, как ${company.legalOwner} обрабатывает персональные данные посетителей сайта Anfas и клиентов, которые оставляют заявки на ремонт, дизайн-проект, комплектацию или консультацию.`,
...
export const meta = () => [
  { title: 'Политика конфиденциальности — Анфас' },
  {
    name: 'description',
    content:
      'Политика обработки персональных данных Anfas: какие данные собирает сайт, зачем они нужны, как защищаются и как отозвать согласие.',
  },
