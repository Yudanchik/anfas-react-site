...
export const meta = () =>
  createSeoMeta({
    ...
    description:
      'Политика ООО «АНФАС» о сборе, хранении и защите персональных данных на сайте. Цели обработки, сроки хранения, права пользователя и контакты оператора.',
    keywords:
      'политика конфиденциальности анфас, персональные данные, обработка персональных данных, политика анфас',
    path: '/privacy',
        ...
        <section className={styles.documentHero}>
          <div>
            ...
            <p className={styles.lead}>
              Здесь описано, какие персональные данные мы собираем на сайте, зачем они нужны и как
