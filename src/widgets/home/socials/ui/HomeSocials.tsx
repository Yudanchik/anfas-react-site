      ...
      <PageWrapper className={styles.socials__layout}>
        <div className={styles.socials__left}>
          <SectionHeader
            ...
            lead="Показываем реальные объекты, решения по интерьеру, подбор материалов и то, как идёт работа на площадке вживую. Так проще почувствовать наш стиль и уровень детализации."
          />
