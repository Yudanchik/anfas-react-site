...
export const processSteps: ReadonlyArray<ProcessStep> = [
  {
    ...
    text: 'Созваниваемся, обсуждаем задачи ремонта квартиры под ключ, выезжаем на объект и фиксируем исходные данные до первого решения.',
  ...
  },
  {
    ...
    text: 'Показываем, как будет работать пространство: логика зон, стилистика, свет, материалы и настроение будущего ремонта квартиры.',
  ...
  },
  {
    ...
    text: 'Собираем прозрачную смету, фиксируем рамку бюджета и раскладываем ремонт квартиры по этапам без плавающих сроков и неожиданностей.',
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'без хаоса', label: 'материалы привязаны к этапам' },
    ],
  },
  {
    mark: '05',
