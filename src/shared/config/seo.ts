...
export const seoQueryClusters = {
  ...
  prices: [
    'прайс-лист ремонт квартир',
    'цены на ремонт квартиры спб',
    'стоимость ремонта квартиры',
    'расценки на ремонт квартиры',
  ...
  blog: [
    'журнал о ремонте квартир',
    'электрика в квартире при ремонте',
    'зачем заливать полы ровнителем',
    'как выбрать сантехнику для ремонта',
    'вентиляция и вытяжка в квартире при ремонте',
    'штукатурка стен при ремонте',
    'ламинат кварцвинил или паркет',
    'советы по ремонту квартиры под ключ',
  ],
} as const
